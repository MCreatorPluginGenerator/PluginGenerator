 ...
 */
public class JCustomizeStringListField extends JPanel {
	 ...
	 */
	public JCustomizeStringListField(Window parent, @Nullable Function<VTextField, Validator> validator) {
	...
	public void setCellRenderer(CustomListCellRenderer listCellRenderer){
		this.entriesList.setCellRenderer(listCellRenderer);
	}

	public void addMouseListener(MouseListener mouseListener){
		entriesList.addMouseListener(mouseListener);
	}
	 ...
	 */
	public JCustomizeStringListField setUniqueEntries(boolean uniqueEntries) {
	...
	public static class CustomListCellRenderer extends JLabel implements ListCellRenderer<String> {

...
import org.cdc.generator.elements.PluginCustomProcedureModElement;
 ...
 * &#064;CreatedIn  2026/5/30
 */
public class PluginCustomProcedureModElementGUI
        extends AbstractProceduresModElementGUI<PluginCustomProcedureModElement>
        implements IQuickCreateImplModElement {
    @InjectField Container container;

    private JTextField parentFolder = new JTextField();

    public PluginCustomProcedureModElementGUI(MCreator mcreator, @NotNull ModElement modElement, boolean editingMode) {
    ...
    @Override protected void openInEditingMode(PluginCustomProcedureModElement generatableElement) {
        super.openInEditingMode0(generatableElement);
        this.parentFolder.setText(generatableElement.parentFolder);
    }

    @Override public PluginCustomProcedureModElement getElementFromGUI() {
        this.modElement.setRegistryName(name.getText());
        var element = new PluginCustomProcedureModElement(modElement);
    ...
    @Override public void createImpl(String generator, String availableElementNameGenerator) {
        ModElement modElement1 = new ModElement(mcreator.getWorkspace(),
                modElement.getName() + "PluginCustomProcedureImpl" + availableElementNameGenerator,
